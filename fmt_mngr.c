...
/**
*
* fmt_mngr - directs/retrieves data to/from formatting and conversion funcs
* @args: arg list
* @index: pointer to start of format spec in format string
* 
	...
	/* retrieve conversion function by arg type */
		switch (arg_type)
		{
			...
			case 2:
				...
				cnvrtd_str = cnvrt_lu(va_arg(args, unsigned));
				break;
			case 3:
				cnvrt_lu = lu_fp_mngr(fmt_spec);
